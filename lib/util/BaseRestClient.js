...
class BaseRestClient {
    ...
    constructor(restOptions = {}, networkOptions = {}) {
        ...
        this.globalRequestOptions = Object.assign(Object.assign({ 
            ...
            timeout: 1000 * 60 * 5 }, networkOptions), { headers: Object.assign({ 'X-CHANNEL-API-CODE': 'hbnni', 'Content-Type': 'application/json', locale: 'en-US' }, (restOptions.demoTrading ? { paptrading: '1' } : {})) });
